...
export const FULL_TIME_FORMAT2 = 'THH:mm:ss';
export const FULL_DATE_TIME_FORMAT = 'DD/MM/YYYY, HH:mm:ss';
export const DATE_TIME_FORMAT = 'DD/MM/YYYY, HH:mm';
export const DATE_TIME_FORMAT2 = 'MMMM DD, YYYY, [at] HH:mm:ss';
export const DATE_TIME_FORMAT_WITH_AMPM = 'DD/MM/YYYY_hh:mmA';
export const DATE_TIME_FORMAT_WITH_AMPM2 = 'DD MMM YYYY hh:mm a';
