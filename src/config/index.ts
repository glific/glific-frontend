...
let pageTitle = envVariables.REACT_APP_PAGE_TITLE;
...
export const APP_NAME = appName ? appName : 'Glific';
export const PAGE_TITLE = pageTitle ? pageTitle : `${APP_NAME}: Two way communication platform`;
