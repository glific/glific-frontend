    ...
    <div className={styles.Main}>
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              You are required to identify an appropriate administrative username and password for
              your account to be created with the Company to avail access to the Glific SaaS
              platform. You will be provided with reasonable technical support services in
              accordance with the Company’s standard practice and the Company will respond to
              technical issues raised by Customer within a reasonable period of time during normal
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              you, the Company may discontinue your access and use of the Services with immediate
              effect.
            </li>
            <li>
              Upon discontinuing your use of Services, the Company will promptly delete all Customer
              Data as soon as reasonably practical after the date of such discontinuation.
            </li>
            <li>
              All sections of this Glific SaaS Terms and Conditions which by their nature should
              survive termination, will survive termination, including, without limitation, the
              terms in relation to Payment of Fees, Warranty and Disclaimer, Indemnity Limitations
              of Liability, Assignment, Severability, Amendment, Governing Law and Jurisdiction,
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              the Customer Data and will use the Services only for lawful purposes approved by the
              Company and in compliance with the Company’s standard published policies then in
              effect (Policy) and all applicable laws and regulations.
            </li>
            <li>
              You agree to indemnify and hold harmless the Company against any damages, losses,
              liabilities, settlements and expenses (including without limitation costs and
              attorneys’ fees) in connection with any claim or action that arises from an alleged
              violation of the foregoing or otherwise from your use of Services.
            </li>
            <li>
              You agree that while the Company has no obligation to monitor your use of the
              Services, the Company may, subject to applicable law, review and prohibit any use of
              the Services that the Company believes may be (or alleged to be) in violation of the
              Glific SaaS Terms and Conditions set forth herein.
            </li>
            <li>
            ...
            <li>
              ...
              Equipment, your account, passwords (including but not limited to administrative and
              user passwords) and files, and for all uses of your account or the Equipment with or
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              Company no later than 15 (fifteen) business days on receiving the invoice in which the
              error or problem appeared. You agree that the Company may at its sole discretion,
              provide you with an adjustment or credit.
            </li>
            <li>
        ...
        <li>
          ...
          <ul>
            <li>
              You agree to not engage in any terrorist or organized criminal activity during the
              period for which the Services are availed by you. You also agree to not operate, buy,
              sell, promote, or otherwise facilitate the exchange of illegal products or services
