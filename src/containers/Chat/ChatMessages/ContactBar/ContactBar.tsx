...
export const ContactBar: React.SFC<ContactBarProps> = (props) => {
  ...
  if (showClearChatDialog) {
    let bodyContext =
      'All the conversation data for this contact will be deleted permanently from Glific server. This action cannot be undone. However you should be able to access it in reports on DataStudio if you have backup configuration enabled.';
    dialogBox = (
      <DialogBox
