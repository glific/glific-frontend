...
export const failedEvaluationItem = {
  ...
  goldenQaName: 'test_dataset',
  goldenQaDuplicationFactor: 2,
  assistantConfigName: 'Test Assistant',
  assistantConfigVersionNumber: 1,
  assistantId: '45',
...
export const completedEvaluationItem = {
  ...
  goldenQaId: '11',
  assistantConfigVersionId: '1',
  goldenQaName: 'healthcare_dataset',
  goldenQaDuplicationFactor: 3,
  assistantConfigName: 'Health Assistant',
  assistantConfigVersionNumber: 2,
  assistantId: '45',
...
export const runningEvaluationItem = {
  ...
  goldenQaId: '12',
  assistantConfigVersionId: '1',
  goldenQaName: 'running_dataset',
  goldenQaDuplicationFactor: 1,
  assistantConfigName: 'Test Assistant',
  assistantConfigVersionNumber: 1,
  assistantId: '45',
...
export const completedEvaluationWithBothMetrics = {
  ...
  goldenQaId: '13',
  assistantConfigVersionId: '1',
  goldenQaName: 'metrics_dataset',
  goldenQaDuplicationFactor: 2,
  assistantConfigName: 'Multi Metric Assistant',
  assistantConfigVersionNumber: 3,
  assistantId: '46',
