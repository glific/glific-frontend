      ...
      server: {
        ...
        headers: {
          ...
          'Content-Security-Policy':
            "default-src * data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob:; script-src-elem 'self' 'unsafe-inline' https://www.google.com https://www.gstatic.com https://js.stripe.com https://kaapi.projecttech4dev.org; frame-src 'self' https://js.stripe.com/ https://www.google.com https://www.gstatic.com https://kaapi.projecttech4dev.org data:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; connect-src *;",
